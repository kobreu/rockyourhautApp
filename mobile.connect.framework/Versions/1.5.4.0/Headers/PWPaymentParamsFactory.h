 ...
 */
-(PWPaymentParams*)createDirecDebitPaymentParamsWithAmount: (double) amount currency:(PWCurrency) currency subject:(NSString*) subject bankAccount:(NSString *) bankAccount bankNumber:(NSString*) bankNumber bankCountryCode:(NSString*) bankCountryCode name: (NSString *) holderName latitude: (double)latitude longitude: (double) longitude horizontalAccuracy: (double) accuracy error:(NSError **) error;
 ...
 * @param holderName The name of the cardholder
 * @param error A pointer to an NSError object
 * @return Returns a PWPaymentParams object representing a tokenization transaction. Or nil if an error occured. Take a look at the error object for details.
 */
 ...
 */
-(PWPaymentParams*)createDebitCardPaymentParamsWithAmount: (double) amount currency:(PWCurrency) currency subject:(NSString*) subject type: (PWDebitCardType) type number:(NSString *) number issueNumber: (NSString*) issueNumber name: (NSString *) cardholderName startYear: (NSString*) startYear startMonth: (NSString*) startMonth expiryYear:(NSString *) expiryYear expiryMonth:(NSString *) expiryMonth CVV:(NSString *) CVV latitude: (double)latitude longitude: (double) longitude horizontalAccuracy: (double) accuracy error:(NSError **) error;
/**
 ...
 */
-(PWPaymentParams*)createDebitCardTokenizationParamsWithType: (PWDebitCardType) type number: (NSString*) number issueNumber: (NSString*) issueNumber name: (NSString*) cardholderName startYear: (NSString*) startYear startMonth: (NSString*) startMonth expiryYear: (NSString*) expiryYear expiryMonth: (NSString*) expiryMonth CVV: (NSString*) CVV error: (NSError**) error;
 ...
 */
-(PWPaymentParams*)createDebitCardPaymentParamsWithPaymentParams:(PWPaymentParams*) genericParams type: (PWDebitCardType) type number:(NSString *) dcNumber issueNumber: (NSString*) issueNumber name: (NSString*) cardholderName startYear: (NSString*) startYear startMonth: (NSString*) startMonth expiryYear:(NSString *) expiryYear expiryMonth:(NSString *) expiryMonth CVV:(NSString *) CVV error:(NSError **) error;
...
/**
 * Create a PWPaymentParamsObject representing a transaction using the data associated with a token
 * @param amount The amount of the transaction. Must be larger than zero.
 * @param currency The currency of the transaction
 * @param subject The description or subject of the transaction
 * @param token The token that is associated with payment data
 * @param error A pointer to an NSError object
 * @return Returns a PWPaymentParams object representing a direct debit transaction. Or nil if an error occured. Take a look at the error object for details
 */
