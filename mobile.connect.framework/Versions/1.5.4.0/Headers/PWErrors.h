...
More detailed errors for the ones checked inside payworks.connect are encoded into the [NSError userInfo] NSDictionary. The relevant fields are the return code and the description of the error.
...
*Payment Params error (11xx)*
 ...
 - 1125: Invalid credit card brand. Currently only VISA, MasterCard, Diners, JCB, China UnionPay, American Express are supported.
