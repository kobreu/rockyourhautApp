...
/** The status of the transaction as defined by the corresponding enum */
@property (nonatomic) PWTransactionStatus status;

/** The unique mobile transaction ID used to identify every mobile transaction done using the payworks framework */
@property (nonatomic, strong) NSString* mobileIdentifier;

/** @name Processer Specific Properties */

/** The unique transaction identifier as provided by the payworks processing system. This identifier needs to be used when using specific properties of the processing system (not only mobile transactions) */
@property (nonatomic, strong) NSString *processorIdentifier;

/** A short identifier to represent the transaction in the payworks processing system. Note, that this is not unique. */
